...
const Expenses = () => {
 ...
 const {
    ...
    const aggregateData: AggregateDataItem[] = useMemo(() => {
        const filtered: AggregateData = expenses.filter((data: ExpenseByCategorySummary) => {
      ...
      <div className="mb-5 "> 
         <Header 
          ...
          <p className="text-sm text-gray-500">
            A visual representation fo expenses over time.
          </p>
      </div>
         ...
         <div className="flex flex-col md:flex-row justify-between gap-4 ">
            <div className="w-full md:w-1/3 bg-white shadow rounded-lg p-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                    ...
                    <select name="category" id="category" className={classNames.selectInput}
                        defaultValue="All"
            ...
            {/* pie charts */}
            <div className="flex-grow bg-white shadow rounded-lg md:p-6 ">
                <ResponsiveContainer width="100%" height={400}>
                    <PieChart>
                        ...
                        data={aggregateData}
                         ...
                         >
                            {aggregateData.map((entry: AggregateDataItem,index:number)=>(
